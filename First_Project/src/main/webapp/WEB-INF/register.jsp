	...
	<div id="wrapper">
		...
		<div class="header">	
			...
			<h1>Taco Bus</h1>
				<ul class="nav-bar">
					...
					<li><a href="/login">Already Have An Account? Login Here</a></li>
				</ul>		
			</div>
		...
		<div class="main-content">
			...
			<div class="form-background">	
				...
				<div class="row">
	   				<div class="col-passwords">
	   					<div class="col-passwords-p">
			
							<form:errors path="password"></form:errors>
							<form:password class="form-control" placeholder="Password" path="password"/>
						</div>
						<div class="col-passwords-c">
							
							<form:errors path="confirmPassword"></form:errors>
							<form:password class="form-control" placeholder="Confirm Password" path="confirmPassword"/>
						</div>
					</div>
					<div class="col-button">
						<form:button class="reg-button">Register</form:button>
					</div>
				</div>
			</form:form>
		</div>
