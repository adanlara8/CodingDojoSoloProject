...
<div id="wrapper">
		...
		<div class="menu-form-main-content">
			<h2>Would you like to Change the ${drink.name}</h2>	
			<div class="editfood-form-container">	
				<form:form class="item-form" action="/editDrink/${user.id}/${drink.id}" method="POST" modelAttribute="drink">
				...
				<a href="/deleteDrink/${drink.id}">Delete From Menu</a>
			</div>				
			</div>	
