		...
		<div class="header">	
			...
			<div class="menu-form-main-content">		
				...
				<div class="menu-form-container">
					<form:form class="item-form" action="/addDish" method="POST" modelAttribute="foodItem">
						<form:label path="name">Name of New Dish</form:label>
						...
						<form:button class="item-button">Add Dish</form:button>
					</form:form>
				</div>
				<div class="menu-form-container">
					<form:form class="item-form" action="/addDrink" method="POST" modelAttribute="drink">
						<form:label path="name">Name of New Drink</form:label>
						<form:errors path="name"/>
						<form:input class="form-control" placeholder="Name" path="name"/>
						...
						<form:button class="item-button">Add Drink</form:button>
					</form:form>
				</div>
				<div class="menu-form-container">				
					<form:form class="item-form" action="addMeat/" method="POST" modelAttribute="meat">	
						<form:label path="name">Name of New Meat Option</form:label>	
						<form:errors path="name"/>
						<form:input class="form-control" placeholder="Name" path="name"/>	
					
						<form:button class="item-button">Add Meat</form:button>
					</form:form>
				</div>
			</div>		
